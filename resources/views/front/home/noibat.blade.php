                            ...
                            <div class="tab-content">
                                <div class="link-readmore text-center clearfix">
                                    <div class="link-inner">
                                        <a class="btn btn-theme btn-outline">Nổi Bật</a>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="product-block grid" data-product-id="632">
                                                        <div class="grid-inner">
                                                            <div class="block-inner">
                                                                <figure class="image">
																	<a style="position: relative" title="{{ $product->name }}" href="{{ url('p')  }}/{{ $product->slug }}" class="product-image">
                                                                        <img style="background-color: #{{ $product->color_code }}" width="540" height="690" src="{{ config('services.design_url') }}/uploads/product/unisex-cotton-tee-front.png" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail unveil-image" alt=""  />
